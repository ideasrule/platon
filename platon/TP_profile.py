...
class Profile:
    def __init__(self, num_profile_heights=250, min_P=1e-3, max_P=1e8):
    ...
    def set_from_params_dict(self, profile_type, params_dict):
        if profile_type == "isothermal":
            ...
            if params_dict["log_surface_P"] is not None:
                log_P3 = params_dict["log_surface_P"]
            elif params_dict["log_cloudtop_P"] is not None:
                log_P3 = params_dict["log_cloudtop_P"]
            self.set_parametric(
                params_dict["T0"], 10**params_dict["log_P1"],
                params_dict["alpha1"], params_dict["alpha2"],
                10**log_P3, params_dict["T3"])
    ...
    def set_from_radiative_solution(self, T_star, Rs, a, Mp, Rp, beta, log_k_th, log_gamma, log_gamma2=None, alpha=0, T_int=0, **ignored_kwargs):

...
class CombinedRetriever:
    ...
    def _ln_like(self, params, transit_calc, eclipse_calc, fit_info, measured_transit_depths,
        ...
        cloud_frac = params_dict["cloud_frac"]
        ...
        try:
            if measured_transit_depths is not None:
                ...
                transit_wavelengths, transit_depths_cloud, transit_info_dict = transit_calc.compute_depths(
                ...
                transit_wavelengths, transit_depths_clear, transit_info_dict = transit_calc.compute_depths(
                    Rs, Mp, Rp, T, logZ, CO_ratio,
                    scattering_factor=scatt_factor, scattering_slope=scatt_slope,
                ...
                calculated_transit_depths = cloud_frac * transit_depths_cloud + (1 - cloud_frac) * transit_depths_clear
